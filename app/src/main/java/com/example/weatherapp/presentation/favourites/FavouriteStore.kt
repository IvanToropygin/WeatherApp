...
import com.example.weatherapp.presentation.favourites.FavouriteStore.Intent
import com.example.weatherapp.presentation.favourites.FavouriteStore.Label
import com.example.weatherapp.presentation.favourites.FavouriteStore.State
...
class FavouriteStoreFactory @Inject constructor(
    ...
    private sealed interface Msg {
        ...
        data class WeatherLoaded(val cityId: Int, val tempC: Float, val conditionUrl: String) : Msg
